...
DATE := $(shell date +%s)
VERSION_FLAGS=\
  -X github.com/P8api/cw-cli/cmd/version.Version=$(GIT_TAG) \
  -X github.com/P8api/cw-cli/cmd/version.Commit=$(GIT_SHA) \
  -X github.com/P8api/cw-cli/cmd/version.Date=$(DATE) \
  -X github.com/P8api/cw-cli/cmd/version.BuiltBy=makefile
